...
export default function SignupPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      toast("Compte cree ! Verifiez votre email pour confirmer.", "success");
      router.push("/login");
    } catch (err: unknown) {
      toast(err instanceof Error ? err.message : "Erreur lors de la creation du compte", "error");
    } finally {
      setLoading(false);
    }
  }
  ...
  return (
    <AuthCard title="Creer un compte" subtitle="Rejoignez Sendia et automatisez vos emails.">
      <form onSubmit={handleSubmit} className="flex flex-col gap-[18px]">
        ...
        <Input label="Mot de passe" type="password" value={password}
          ...
          placeholder="••••••••" required autoComplete="new-password" hint="Minimum 8 caracteres" />
